...
/**
 * Follows the process's holds as they come and go — a dev supervisor's lease projection in a
 * consumer application is the one consumer; it never decides anything here.
 */
